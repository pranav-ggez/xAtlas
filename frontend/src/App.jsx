      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexShrink: 0 }}>
          <button
            ...
            onMouseEnter={(e) => {
              e.target.style.background = isPaused ? 'rgba(16, 185, 129, 0.3)' : 'rgba(239, 68, 68, 0.3)'
            }}
            onMouseLeave={(e) => {
              e.target.style.background = isPaused ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.2)'
            }}
          >
              ...
              <div style={{ marginTop: '20px', borderTop: '1px solid #333', paddingTop: '15px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  <a 
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.background = 'rgba(10, 102, 194, 0.25)'
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.background = 'rgba(10, 102, 194, 0.15)'
                    }}
                  >
                  ...
                  <a 
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.background = 'rgba(88, 101, 242, 0.25)'
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.background = 'rgba(88, 101, 242, 0.15)'
                    }}
                  >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#5865F2' }}>
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '15px' }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    fontSize:'0.7rem', 
                    color: selectedTool.signed_releases ? '#10b981' : '#f59e0b', 
                    marginBottom:'3px'
                  }}>
                    Security
                  </div>
              ...
              {selectedTool.official_link && (
                <a 
                  ...
                  onMouseEnter={(e) => {
                    e.target.style.boxShadow = '0 0 25px rgba(16, 185, 129, 0.7)'
